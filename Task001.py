...
pygame.display.set_caption('Игра в крестики-нолики')
        ...
        for col in range(3):
            ...
            if mas[row][col] == 'x':
                pygame.draw.line(screen, red, (x+5, y+5),
                                 (x+size_block-5, y+size_block-5), 8)
                pygame.draw.line(screen, red, (x+size_block-5,
                                 y+5), (x+5, y+size_block-5), 8)
            elif mas[row][col] == 'o':
                pygame.draw.circle(
                    screen, red, (x+size_block//2, y+size_block//2), size_block//2-3, 8)
            check_win(mas)
            if query == 9:
